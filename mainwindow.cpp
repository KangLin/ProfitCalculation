...
int MainWindow::ShortProfilteCalculation()
{
    ...
    ui->leShorts_Purchase->setText(QString::number(CProfiltCalculation::ShortsProfiltCalculation(dbSelling, dbProfilt, dbFee)));
    return 0;
}
...
int MainWindow::LongProfilteCalculation()
{
    ...
    ui->leLong_Selling->setText(QString::number(CProfiltCalculation::LongProfilteCalculation(dbPurchase, dbProfilt, dbFee)));
    return 0;
}
